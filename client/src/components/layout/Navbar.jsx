      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            {/* Search */}
            <button onClick={() => navigate('/shop')} className="text-white/70 hover:text-gold-500 transition-colors focus-visible:ring-1 focus:outline-none" aria-label="Search" title="Search">
            ...
            {user ? (
              <div className="relative">
                <button onClick={() => setUserMenu(!userMenu)} className="flex items-center gap-2 text-white/70 hover:text-white transition-colors focus-visible:ring-1 focus:outline-none" aria-label="Toggle user menu" aria-expanded={userMenu}>
            ...
            {/* Mobile Hamburger */}
            <button onClick={() => setMenuOpen(!menuOpen)} className="lg:hidden text-white/70 hover:text-white transition-colors ml-2 focus-visible:ring-1 focus:outline-none" aria-label="Toggle mobile menu" aria-expanded={menuOpen}>
