      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            {/* Search */}
            <button aria-label="Search" onClick={() => navigate('/shop')} className="text-white/70 hover:text-gold-500 transition-colors">
            ...
            {user ? (
              <div className="relative">
                <button aria-label="User menu" onClick={() => setUserMenu(!userMenu)} className="flex items-center gap-2 text-white/70 hover:text-white transition-colors">
            ...
            {/* Mobile Hamburger */}
            <button aria-label="Toggle navigation menu" onClick={() => setMenuOpen(!menuOpen)} className="lg:hidden text-white/70 hover:text-white transition-colors ml-2">
