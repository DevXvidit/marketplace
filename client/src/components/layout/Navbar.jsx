        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-white/70 hover:text-gold-500 transition-colors focus-visible:ring-1 focus-visible:ring-gold-500 focus:outline-none rounded"
            ...
            {user && (
              <Link
                to="/wishlist"
                className="relative text-white/70 hover:text-gold-500 transition-colors group focus-visible:ring-1 focus-visible:ring-gold-500 focus:outline-none rounded"
                title="My Wishlist"
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 text-white/70 hover:text-white transition-colors focus-visible:ring-1 focus-visible:ring-gold-500 focus:outline-none rounded"
            ...
            <button
              ...
              className="lg:hidden text-white/70 hover:text-white transition-colors ml-2 focus-visible:ring-1 focus-visible:ring-gold-500 focus:outline-none rounded"
