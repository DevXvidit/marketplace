                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-luxury-muted hover:text-gold-400 focus:outline-none focus-visible:ring-1 focus-visible:ring-gold-500 rounded-sm"
