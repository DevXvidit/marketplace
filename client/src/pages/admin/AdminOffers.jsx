                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => handleEdit(offer)} className="w-10 h-10 flex items-center justify-center border border-white/5 text-white/20 hover:text-blue-500 hover:border-blue-900/40 hover:bg-blue-900/10 transition-all flex-shrink-0 rounded-sm" title="Edit Campaign" aria-label="Edit Campaign">
                          <span className="text-sm">✎</span>
                        </button>
                        <button onClick={() => handleDelete(offer._id)} className="w-10 h-10 flex items-center justify-center border border-white/5 text-white/20 hover:text-red-500 hover:border-red-900/40 hover:bg-red-900/10 transition-all flex-shrink-0 rounded-sm" title="Terminate Campaign" aria-label="Terminate Campaign">
