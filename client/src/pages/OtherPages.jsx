          ...
          {[
            ...
            <div key={key}>
              ...
              <div className="relative">
                <input type={key === 'password' && !showPw ? 'password' : (key === 'password' ? 'text' : type)} value={form[key]} onChange={e => setForm(f => ({ ...f, [key]: e.target.value }))}
                  placeholder={placeholder} required={key !== 'phone'} className={`input-luxury w-full ${key === 'password' ? 'pr-10' : ''}`} />
                {key === 'password' && (
